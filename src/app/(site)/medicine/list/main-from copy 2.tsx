...
const MainForm = () => {
  ...
  const getStatusClass = (status: string | undefined) => {
    switch (status) {
      case 'จัดยาแล้ว': return 'bg-green-500 text-white';
      case 'แนบใบสั่ง': return 'border-pink-500 bg-green-500 text-white';
      case 'มีใบแนบ': return 'bg-pink-500 text-white';
      case 'รอจับคู่ตะกร้า': return 'bg-orange-200 text-black';
      case 'กำลังตรวจสอบ': return 'bg-blue-500 text-white';
      case 'ยกเลิก': return 'bg-red-500 text-white';
      case 'กำลังจัดยา': return 'bg-orange-500 text-white';
